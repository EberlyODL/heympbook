...
**Isotopes:** Most elements have an equal number of neutrons and protons, although this varies (e.g., hydrogen has one proton but no neutron). The number of protons in a nucleus is what decides its name and a lot of its properties. An atom with 6 protons in the nucleus is called carbon. An isotope is an element with the same number of protons but different number of neutrons. Deuterium, often called heavy hydrogen, is a common isotope of hydrogen. A nucleus of deuterium has 1 proton and 1 neutron. Deuterium is a stable element. Because the nucleus is twice as heavy as normal hydrogen, deuterium is often called heavy hydrogen. When deuterium is used to make water (i.e., D<SUB>2</SUB>O), we call it heavy water. Heavy water is used to cool nuclear reactors, for example. Tritium is another isotope of hydrogen. It has 1 proton and 2 neutrons. It is unstable and radioactive, and much rarer on our planet.

**Ions:** Finally, an ion is an atom which has more or fewer electrons than the number of protons. If the atom has one more electron than protons, it will have a net negative charge; i.e., it is a negative ion. If one electron is taken away from a neutral atom, it will have a net positive charge; i.e., it became a positive ion.